<template>
    ...
    <div class="list-page lock-list-page" style="margin-top:5%;">
    ...
    export default {
        data: function() {
            return {
                ...
                gas_img: '<img src="/Public/iyuho/img/gasLogo.svg" alt="gas" style="width:28px">',
                nft_img: '<img src="/Public/iyuho/img/NFT.png" alt="gas" style="width:28px">',
                pin_img: '<img src="/Public/iyuho/img/pin1.png" alt="pin" style="width:28px">',
